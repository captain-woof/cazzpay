...
interface CazzPayTokenInterface extends ethers.utils.Interface {
  functions: {
    "addOwner(address)": FunctionFragment;
    "allowance(address,address)": FunctionFragment;
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "burnTokensFromOwner(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "burnTokensFromOwner",
    values: [string, BigNumberish]
  ): string;
...
export class CazzPayToken extends BaseContract {
  ...
  interface: CazzPayTokenInterface;
